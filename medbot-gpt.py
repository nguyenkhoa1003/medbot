...
# chatbot using Langchain, the openAI API, and health information
# from MedlinePlus and UI from Gradio
# . The chatbot can answer user questions about various
...
#
#   pip install langchain langchain_community langchain_text_splitters langchain_openai langchain_chroma faiss-cpu beautifulsoup4 gradio python-dotenv requests
#
...
if not OPENAI_API_KEY:
    raise ValueError("Google API key not found. Please set the OPENAI_API_KEY environment variable.")
...
def main():
    ...
    iface = gr.Interface(
        ...
        outputs="text",
        title="MedPrompt",
        description="MSAI-630-M40: Group 2. This chatbot uses Langchain, ChatGPT, and MedlinePlus data to answer your health questions. And Gradio for the fastest way for UI",
        theme="soft",
        flagging_mode="never",
    )
    iface.launch()
